"""EEGNet trained within-subject (standard benchmark protocol) for subjects 1-9."""
import mne
import moabb
import torch
...
def train_one_subject(subj, dataset):
    ...
    lightning_model = LightningWrapper(model, lr=1e-3)
...
print("✅ Within-subject EEGNet training works end-to-end!")
